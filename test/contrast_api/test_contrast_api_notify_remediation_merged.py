...
class TestContrastApiNotifyRemediationMerged(unittest.TestCase):
    """Test cases for notifying remediation of PR merged in contrast_api module."""

    def setUp(self):
        """Set up test environment before each test."""
        self.mock_response = MagicMock()

    def _call_notify_remediation_pr_merged(self, **overrides):
        defaults = {
        ...
        return contrast_api.notify_remediation_pr_merged(
            **{**defaults, **overrides})
    ...
    def test_pr_merged_returns_valid_response_object(self, mock_put):
        ...
        result = self._call_notify_remediation_pr_merged()
